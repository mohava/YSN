...
public class Testing {
	public static void main(String[] args) throws FileNotFoundException{
		...
		Event testevent = new Event("Test event","test event text area",0,new Object[]{"test0","test1"},new IntModifier[]{new IntModifier(int1,1,new Req[]{new Req(int1,1)}),new IntModifier(int2,-2)});
		testevent.doEvent();
